...
class Venue: Codable {
    ...
    init(id: String, alias: String, name: String, imageURL: String, isClosed: Bool, url: String, reviewCount: Int, categories: [Category], rating: Int, coordinates: Coordinates, transactions: [JSONAny], price: String, location: Location, phone: String, displayPhone: String, distance: Double) {
        self.id = id
        self.alias = alias
        self.name = name
